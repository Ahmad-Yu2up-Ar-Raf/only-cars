...
function DataTableActionBarAction({
  ...
  const trigger = (
    <Button
      ...
      size={size}
      className={cn(
        "gap-1.5 border border-secondary  text-accent-foreground bg-secondary/50 hover:bg-secondary/70 [&>svg]:size-3.5",
